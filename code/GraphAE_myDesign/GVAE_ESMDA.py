...
N_ensambels =100
# Correct code
measurment_tensor = torch.ones(len(surface_indeces), 3)
...
param_enc.read_weight_path = "../../train/graphAE_Breast/weight_00/model_epoch0372.weight"
print (param_enc.read_weight_path)

test_npy_fn = "../../data/Breast/test.npy"

out_test_folder = "../../train/graphAE_Breast/test_1/epoch372/"
